...
void updateConfig(vsemi_tof_ros::vsemi_tof_rosConfig &config, uint32_t level)
{
	...
	globle_settings.automaticIntegrationTime = config.automatic_integration_time;
	...
	globle_settings.integrationTimeATOF2  = static_cast<uint>(config.integration_time_2);
	globle_settings.integrationTimeATOF3  = static_cast<uint>(config.integration_time_3);
	globle_settings.integrationTimeBTOF4  = static_cast<uint>(config.integration_time_4);
	globle_settings.integrationTimeBTOF5  = static_cast<uint>(config.integration_time_5);

	globle_settings.integrationTimeGray   = static_cast<uint>(config.integration_time_gray);
	...
	globle_settings.minAmplitude2 = static_cast<uint>(config.min_amplitude_2);
	globle_settings.minAmplitude3 = static_cast<uint>(config.min_amplitude_3);
	globle_settings.minAmplitude4 = static_cast<uint>(config.min_amplitude_4);
	globle_settings.minAmplitude5 = static_cast<uint>(config.min_amplitude_5);

	globle_settings.dcsFilter = config.dcs_filter;

	globle_settings.range   = static_cast<uint>(config.range);
